...
exec: $(OBJ_DIR)/main.o $(OBJ_DIR)/fornecedores.o $(OBJ_DIR)/carrinho.o $(OBJ_DIR)/notafiscal.o $(OBJ_DIR)/cadProd.o $(OBJ_DIR)/estoque.o $(OBJ_DIR)/menu.o $(OBJ_DIR)/pereciveis.o $(OBJ_DIR)/produtos.o $(OBJ_DIR)/data.o $(OBJ_DIR)/bebidas.o $(OBJ_DIR)/cds.o $(OBJ_DIR)/doces.o $(OBJ_DIR)/dvds.o $(OBJ_DIR)/frutas.o $(OBJ_DIR)/livros.o $(OBJ_DIR)/salgados.o
	@echo "============="
	@echo "Ligando o alvo $@"
	@echo "============="
	$(CC) $(CFLAGS) -o $(BIN_DIR)/$@ $^
...
$(OBJ_DIR)/main.o: $(SRC_DIR)/main.cpp $(INC_DIR)/fornecedores.h $(INC_DIR)/cadProd.h $(INC_DIR)/menu.h $(INC_DIR)/estoque.h $(INC_DIR)/carrinho.h $(INC_DIR)/notafiscal.h
	$(CC) -c $(CFLAGS) -o $@ $<	
