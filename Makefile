...
exec: $(OBJ_DIR)/main.o $(OBJ_DIR)/menu.o $(OBJ_DIR)/pereciveis.o $(OBJ_DIR)/produtos.o $(OBJ_DIR)/data.o $(OBJ_DIR)/bebidas.o $(OBJ_DIR)/cds.o $(OBJ_DIR)/doces.o $(OBJ_DIR)/dvds.o $(OBJ_DIR)/frutas.o $(OBJ_DIR)/livros.o $(OBJ_DIR)/salgados.o
	@echo "============="
	@echo "Ligando o alvo $@"
	@echo "============="
	$(CC) $(CFLAGS) -o $(BIN_DIR)/$@ $^
...
$(OBJ_DIR)/main.o: $(SRC_DIR)/main.cpp $(SRC_DIR)/menu.cpp $(SRC_DIR)/pereciveis.cpp $(SRC_DIR)/produtos.cpp $(SRC_DIR)/bebidas.cpp $(SRC_DIR)/cds.cpp $(SRC_DIR)/data.cpp $(SRC_DIR)/doces.cpp $(SRC_DIR)/dvds.cpp $(SRC_DIR)/frutas.cpp $(SRC_DIR)/livros.cpp $(SRC_DIR)/salgados.cpp $(INC_DIR)/menu.h $(INC_DIR)/pereciveis.h $(INC_DIR)/produtos.h $(INC_DIR)/bebidas.h $(INC_DIR)/cds.h $(INC_DIR)/data.h $(INC_DIR)/doces.h $(INC_DIR)/dvds.h $(INC_DIR)/frutas.h $(INC_DIR)/livros.h $(INC_DIR)/salgados.h
	$(CC) -c $(CFLAGS) -o $@ $<	
