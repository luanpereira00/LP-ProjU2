...
void cadastrarProdutos(Estoque *e, int a){
	...
	int auxI;
	Data dv;
	dv.string2Data("01/02/1999");
	Bebidas c(10, "CACHACA SAMANAU", 15, 14, 120, 30, 9, dv);
	
	Produtos *p = new Bebidas;
	p->setNomeProd("SAMANAU")
	Bebidas *b = dynamic_cast<Bebidas *>(p);
...
/*
    ...
    Derived* b = static_cast<Derived*>(p); //
*/
	...
	if(a!=0){
		switch(a){
			case 1: //BEBIDAS
				...
				cout << "Digite a chave de busca para remover o produto: ";
				cin >> key;
